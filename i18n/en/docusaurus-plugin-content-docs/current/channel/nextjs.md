---
title: Nextjs Integration Guide
sidebar_label: Nextjs
sidebar_position: 5
description: Integrate the Weiyu customer service system into a Nextjs application
---
...
```bash
import { BytedeskNextjs } from 'bytedesk-web/react';
