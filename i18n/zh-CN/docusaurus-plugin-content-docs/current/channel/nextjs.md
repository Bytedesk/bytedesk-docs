...
sidebar_position: 5
description: 在 Next.js 应用中集成微语客服系统
---

## 功能简介

Next.js是基于React的生产级框架，通过集成微语客服系统到您的Next.js应用中，可以为用户提供便捷的在线客服功能。支持自定义主题、拖拽、多语言等丰富特性，完美融入您的Next.js项目。

- 演示链接：[Next.js 基础集成演示](https://weiyuai.cn/reactdemo/)
- 演示代码：[Next.js 基础集成示例](https://github.com/Bytedesk/bytedesk-web/blob/master/examples/nextjs-demo/src/components/InstallGuide.tsx)
