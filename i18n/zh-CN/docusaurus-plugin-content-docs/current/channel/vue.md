...
Vue是目前最流行的前端框架之一，通过集成微语客服系统到您的Vue应用中，可以为用户提供便捷的在线客服功能。支持自定义主题、拖拽、多语言等丰富特性，完美融入您的Vue项目。

- 演示链接：[Vue 基础集成演示](https://weiyuai.cn/reactdemo/)
- 演示代码：[Vue 基础集成示例](https://github.com/Bytedesk/bytedesk-web/blob/master/examples/vue-demo/src/pages/LocalDemo.vue)
