---
sidebar_label: 即时通讯模块定价
sidebar_position: 1
---

# 即时通讯模块源码定价

面向即时通讯场景，覆盖管理端、工作台、移动端与服务端高级能力，适合企业内外部沟通、单聊群聊、消息同步与业务集成等需求。
...
- 注：以上价格为源码价格，不包含二次定制费用、部署服务与运维服务。
- 技术栈：Java + React + Flutter，前后端分离，可按业务需要进行定制开发。
