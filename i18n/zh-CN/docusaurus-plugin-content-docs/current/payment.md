...
| 版本 | 价格 | 主要特点 |
| --- | --- | --- |
| **社区版** | **免费** | 基本功能开源，可商用，单租户，**[社区版源码，保留源码版权声明](./deploy/source.md)**，用户数/客服/机器人/知识库数量不限，保留微语logo，不支持品牌自定义|
| **企业版** | **2.98w** | 单租户，功能完整，**[私有化部署包](./deploy/docker.md)，不含源码**，用户数/客服/机器人/知识库数量不限，支持品牌自定义 |
| **平台版** | **5.98w** | **多租户**，SaaS，功能完整，**[私有化部署包](./deploy/docker.md)，不含源码**，用户数/客服/机器人/知识库数量不限，支持品牌自定义 |
| **产品代理** | **企业版8折** | 适用于购买企业版≥2份授权，**[私有化部署包](./deploy/docker.md)，不含源码** |
| **源码版** | **2.98w起** | **包含完整源码，含高级功能**，支持按模块单独购买。含平台版所有功能，无需再购买企业版或平台版，所购买模块无需授权licenseKey。区别于企业版：可以自行修改源码，支持定制化开发。 |

- 价格为一次性收费，不含税点（公司小规模，如需发票，普票加收1%税点，专票加收1%或3%税点，可选）。
...
| 模块 | 价格 |
| --- | --- |
| 管理后台源码(前端/React) | 4.98w |
| 客服工作台源码(前端/React，支持Web和PC端) | 4.98w |
| 手机客服端源码(安卓/iOS，Flutter) | 4.98w |
| H5访客端源码(前端/React) | 2.98w |
| 服务器高级功能源码(后端/Java) | 4.98w |
...
- 您需要有自己技术人员，负责维护和升级您的系统。因精力有限，不提供免费运维服务。
