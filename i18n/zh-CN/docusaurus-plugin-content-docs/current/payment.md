...
| 模块 | 价格 |
| --- | --- |
| 管理后台源码(前端/React) | ¥59,800 |
| 客服工作台源码(前端/React，支持Web和PC端) | ¥59,800 |
| 知识库管理源码(前端/React) | ¥19,800 |
| 工单流程/工作流/表单低代码源码(前端/React) | ¥19,800 |
| 手机客服端源码(安卓/iOS，Flutter) | ¥59,800 |
| H5访客端源码(前端/React) | ¥39,800 |
| 服务器高级功能源码(后端/Java) | ¥59,800 |
