...
| **平台版** | **6万元** | **多租户**，SaaS，功能完整，**[私有化部署包](./deploy/docker.md)，不含源码**，用户数/客服/机器人/知识库数量不限，支持品牌自定义 |
| **产品代理** | **企业版8折** | 适用于购买企业版≥2份授权，**[私有化部署包](./deploy/docker.md)，不含源码** |
| **源码版** | **3万元起** | **包含完整源码，含高级功能**，支持按模块单独购买。含平台版所有功能，无需再购买企业版或平台版，所购买模块无需授权licenseKey。区别于企业版：可以自行修改源码，支持定制化开发。 |
...
| --- | --- |
| 管理后台源码(前端/React) | 5万元 |
| 客服工作台源码(前端/React，支持Web和PC端) | 5万元 |
| 手机客服端源码(安卓/iOS，Flutter) | 5万元 |
| H5访客端源码(前端/React) | 3万元 |
