...
| **企业版** | **2.98万元** | 单租户，功能完整，**[私有化部署包](./deploy/docker.md)，不含源码**，用户数/客服/机器人/知识库数量不限，支持品牌自定义 |
| **平台版** | **5.98万元** | **多租户**，SaaS，功能完整，**[私有化部署包](./deploy/docker.md)，不含源码**，用户数/客服/机器人/知识库数量不限，支持品牌自定义 |
| **产品代理** | **企业版8折** | 适用于购买企业版≥2份授权，**[私有化部署包](./deploy/docker.md)，不含源码** |
| **源码版** | **2.98万元起** | **包含完整源码，含高级功能**，支持按模块单独购买。含平台版所有功能，无需再购买企业版或平台版，所购买模块无需授权licenseKey。区别于企业版：可以自行修改源码，支持定制化开发。 |
...
| 模块 | 价格 |
| --- | --- |
| 管理后台源码(前端/React) | 4.98万元 |
| 客服工作台源码(前端/React，支持Web和PC端) | 4.98万元 |
| 手机客服端源码(安卓/iOS，Flutter) | 4.98万元 |
| H5访客端源码(前端/React) | 2.98万元 |
| 服务器高级功能源码(后端/Java) | 4.98万元 |
