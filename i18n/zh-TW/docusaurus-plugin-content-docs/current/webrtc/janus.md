...
以下說明僅供參考，具體設定與使用方式請參考 Janus 官方文件：[https://janus.conf.meetecho.com/docs/](https://janus.conf.meetecho.com/docs/)
...
- 線上測試（微語官方）：[https://janus.weiyuai.cn/](https://janus.weiyuai.cn/)
- 參考配置與部署示例：[https://github.com/Bytedesk/bytedesk/tree/main/deploy/janus](https://github.com/Bytedesk/bytedesk/tree/main/deploy/janus)
...
- 官方說明（英文）：[https://github.com/meetecho/janus-gateway?tab=readme-ov-file](https://github.com/meetecho/janus-gateway?tab=readme-ov-file)
...
- 參考：[https://github.com/pengjinning/janus-webrtc-gateway-docker](https://github.com/pengjinning/janus-webrtc-gateway-docker)
...
services:
    janus-gateway:
        ...
        # 建議：僅啟動 Janus（與專案 compose 一致）
        command: ["/usr/local/bin/janus", "-F", "/usr/local/etc/janus"]
        # 若鏡像內含並啟用 Nginx，才改用 nginx + janus：
...
- 官網：[https://janus.conf.meetecho.com/index.html](https://janus.conf.meetecho.com/index.html)
- GitHub：[https://github.com/meetecho/janus-gateway](https://github.com/meetecho/janus-gateway)
- NPM：[https://www.npmjs.com/package/janus-gateway](https://www.npmjs.com/package/janus-gateway)
